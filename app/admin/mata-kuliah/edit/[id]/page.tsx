              ...
              {loading ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-10">
                   ...
                   <div className="mt-6 flex items-center justify-end gap-6 border-t border-gray-50 pt-10">
                      <Link href="/admin/mata-kuliah" className="text-sm font-black text-gray-400 uppercase tracking-widest hover:text-red-600 transition-colors">Batalkan</Link>
                      <button 
                         type="submit"
                         disabled={saving}
                         className="rounded-2xl bg-blue-600 px-12 py-5 text-sm font-black text-white shadow-2xl shadow-blue-600/30 hover:scale-[1.02] active:scale-95 transition-all flex items-center gap-3 uppercase tracking-widest disabled:opacity-50"
                      >
